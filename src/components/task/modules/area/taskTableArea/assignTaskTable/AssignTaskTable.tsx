...
import styles from './AssignTaskTable.module.scss';
...
interface AssignTaskTableProps {
...
const AssignTaskTable = (props: AssignTaskTableProps) => {
  const week = (
    baseDay: number,
    selectedDate: Date,
    cycleType: TaskCycleType | null,
    ...
    for (let i = 0; i < oneWeek; i++) {
      ...
      weekTableItems.push(
        <td className={styles.item} key={i}>
  ...
  return (
    <tr className={styles.listForUser}>
