...
export const groupShoppingListReducers = (
  ...
  switch (action.type) {
    ...
    case Actions.START_EDIT_GROUP_REGULAR_SHOPPING_LIST_ITEM:
      return {
        ...state,
        ...action.payload,
      };
    case Actions.EDIT_GROUP_REGULAR_SHOPPING_LIST_ITEM:
      return {
        ...state,
        ...action.payload,
      };
    ...
    case Actions.START_DELETE_GROUP_REGULAR_SHOPPING_LIST_ITEM:
      return {
        ...state,
        ...action.payload,
      };
    ...
    case Actions.FAILED_DELETE_GROUP_REGULAR_SHOPPING_LIST_ITEM:
      return {
        ...state,
        ...action.payload,
      };
